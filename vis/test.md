...
Виразність + Ефективність
* Візуальне кодування повинно показувати лише ту інформацію, яка є в наших даних. Ми не повинні нашим кодуванням обманювати глядача (виразність)
* Більш важлива інформація повинна бути показана у більш сильний візуальний спосіб. Співвідношення Дані/Чорнила (Ефективність)
